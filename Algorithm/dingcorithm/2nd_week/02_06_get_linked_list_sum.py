...
def get_linked_list_sum(linked_list_1, linked_list_2):
    ...
    while cur_1 is not None:
        num_1 = num_1 * 10 + cur_1.data
        cur_1 = cur_1.next
    while cur_2 is not None:
        num_2 = num_2 * 10 + cur_2.data
        cur_2 = cur_2.next
...
def get_linked_list_sum_a1(linked_list_1, linked_list_2):
...
print(get_linked_list_sum(linked_list_1, linked_list_2)) # 1032
print(get_linked_list_sum_a1(linked_list_1, linked_list_2)) # 1032